...
//     // const res = await fetch('http://127.0.0.1:8090/api/collections/sites', { cache: 'no-store' });

//     // notes/records?page=1&perPage=30
...
export function GlobalNav() {
    ...
    ///api/collections/sites/records/:id

    const { data, error, isLoading } = useSWR('http://127.0.0.1:8090/api/collections/sites/records', (url) => fetch(url).then((res) => res.json())
    )
            ...
            <div className="flex h-14 items-center py-4 px-4 lg:h-auto">
                ...
                >
                    ...
                    <h3 className="font-semibold tracking-wide text-gray-400 group-hover:text-gray-50">
                        WebGallery <span className="Work in progress">(WIP)</span>
                    </h3>
                </Link>
            </div>
            <button
